...
$fileLocation = Join-Path $toolsDir 'amd-software-adrenalin-edition-22.10.1-minimalsetup-221003_web.exe'
...
$packageArgs = @{
  ...
  softwareName  = 'AMD_Adrenaline*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
